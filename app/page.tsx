...
import { ArrowRight, BookOpen, Users, Award, ChevronRight, Star, Monitor, Code, CheckCircle, Menu, FileText, Smile, Briefcase, GraduationCap, Printer, Wifi, Home, Banknote, Heart, Handshake, MapPin, Phone, Mail, HelpCircle, ChevronDown, Target } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/register" className="px-4 py-2 bg-blue-600 text-white rounded-full text-sm font-bold hover:bg-blue-700 transition-colors shadow-sm">
                Daftar Sekarang
              </Link>
            </div>
